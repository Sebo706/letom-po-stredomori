  ...
  destinations: [
    {
      ...
      keywords: "kos kefalos cavo paradiso therma springs asklepion",
      content: [
        { type: "article", label: "Článok", title: "Kos osobne", url: "blog/kos-osobne.html" },
        { type: "video", label: "Video", title: "KOS nás úplne prekvapil", url: "https://youtu.be/uXmfVDSNCM0" },
        { type: "podcast", label: "Podcast", title: "Kos osobne", url: "https://open.spotify.com/episode/4ehHUFn164v8Gb0YNucYau" }
      ]
    },
    {
      id: "cavo-paradiso",
      ...
      keywords: "kos kefalos plaz auto dobrodruzstvo",
      content: [{ type: "article", label: "Článok", title: "5 zaujímavostí Stredomoria – 2. časť", url: "blog/5-zaujimavosti-stredomoria-2.html" }]
    },
    {
      id: "zakynthos",
      name: "Zakynthos",
      ...
      keywords: "zakynthos zante caretta caretta plaze",
      content: [{ type: "article", label: "Článok", title: "Zakynthos osobne", url: "blog/zakynthos-osobne.html" }]
    },
    {
      id: "navagio",
      name: "Navagio",
    ...
    },
    {
      ...
      keywords: "lefkada agios nikitas auto ubytovanie",
      content: [{ type: "article", label: "Článok", title: "Lefkada autom: 3 ubytovania", url: "blog/lefkada-autom-3-ubytovania-agios-nikitas.html" }]
    },
    {
      id: "athens",
      name: "Atény",
      ...
      keywords: "atény anafiotika akropola",
      content: [{ type: "article", label: "Článok", title: "5 zaujímavostí Stredomoria – 3. časť", url: "blog/5-zaujimavosti-stredomoria-3.html" }]
    },
    {
      id: "rome",
      name: "Rím",
      ...
      keywords: "rim rím cestiova pyramida",
      content: [{ type: "article", label: "Článok", title: "5 zaujímavostí Stredomoria – 3. časť", url: "blog/5-zaujimavosti-stredomoria-3.html" }]
    },
    {
      id: "palermo",
      ...
      keywords: "palermo sicilia qanaat qanat",
      content: [{ type: "article", label: "Článok", title: "5 zaujímavostí Stredomoria – 3. časť", url: "blog/5-zaujimavosti-stredomoria-3.html" }]
    },
    {
      id: "san-vito-lo-capo",
      name: "San Vito Lo Capo a Zingaro",
      country: "Taliansko",
      countryId: "italy",
      ...
      keywords: "sicilia sicília zingaro san vito lo capo monte monaco",
      content: [{ type: "article", label: "Článok", title: "5 zaujímavostí Stredomoria – 2. časť", url: "blog/5-zaujimavosti-stredomoria-2.html" }]
    },
    {
      id: "bosa",
      ...
      keywords: "bosa sardinia sardínia mesto hrad",
      content: [{ type: "article", label: "Článok", title: "5 zaujímavostí Stredomoria – 2. časť", url: "blog/5-zaujimavosti-stredomoria-2.html" }]
    },
    {
      id: "barcelona",
      ...
      keywords: "barcelona eixample spanielsko španielsko",
      content: [{ type: "article", label: "Článok", title: "5 zaujímavostí Stredomoria – 3. časť", url: "blog/5-zaujimavosti-stredomoria-3.html" }]
    },
    {
      id: "malaga",
      ...
      keywords: "malaga málaga andaluzia more mesto",
      content: [{ type: "article", label: "Článok", title: "5 zaujímavostí Stredomoria – 1. časť", url: "blog/5-zaujimavosti-stredomoria-1.html" }]
    },
    {
      id: "marseille",
      name: "Marseille",
      ...
      keywords: "francuzsko francúzsko marseille provence",
      content: [{ type: "article", label: "Archív", title: "Články o Francúzsku", url: "clanky.html?krajina=francuzsko" }]
    },
    {
      id: "dubrovnik",
      name: "Dubrovník",
      ...
      keywords: "dubrovnik dubrovník lazareti chorvatsko chorvátsko",
      content: [{ type: "article", label: "Článok", title: "5 zaujímavostí Stredomoria – 3. časť", url: "blog/5-zaujimavosti-stredomoria-3.html" }]
    },
    {
      id: "valletta",
      ...
      keywords: "malta valletta valletta valetta",
      content: [{ type: "article", label: "Článok", title: "Malta v júli", url: "blog/malta-jul-isle-of-mtv-more-horucavy.html" }]
    },
    {
      id: "larnaka",
      name: "Larnaka",
      ...
      keywords: "cyprus larnaka slane jazero plameniaky",
      content: [{ type: "article", label: "Článok", title: "Soľné panvy Stredomoria", url: "blog/solne-panvy-stredomoria.html" }]
    },
    {
      id: "ayia-napa",
      name: "Ayia Napa a Protaras",
      country: "Cyprus",
      countryId: "cyprus",
      ...
      keywords: "cyprus ayia napa protaras varosha cape greco",
      content: [{ type: "article", label: "Článok", title: "5 zaujímavostí Stredomoria – 2. časť", url: "blog/5-zaujimavosti-stredomoria-2.html" }]
    },
    {
      id: "piran",
