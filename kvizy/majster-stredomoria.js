(() => {
  ...
  const storageKey = "letom-majster-stredomoria-sound";
  ...
  function finishGame(state) {
    ...
    if (state === "win") {
      ...
      elements.resultTitle.textContent = "SI MAJSTER STREDOMORIA!";
      elements.resultText.textContent = "Zvládol si všetkých 15 otázok a doplával až na vrchol.";
